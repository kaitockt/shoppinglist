  ...
  input.addEventListener("input", function (e) {
    ...
    whitelist.forEach(function (item) {
      if (item.substr(0, val.length).toUpperCase() == val.toUpperCase()) {
        b = document.createElement("div"); //bold the matching letters

        b.innerHTML = "<strong>" + item.substr(0, val.length) + "</strong>" + item.substr(val.length) + "<input type='hidden' value='" + item + "'>";
