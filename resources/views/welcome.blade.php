    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="flex flex-col justify-around h-full">
            <div>
                ...
                <p class="mb-6 text-gray-600 text-center font-light">Shopping made easy</p>
                <ul class="flex flex-col justify-around space-y-2 sm:flex-row sm:flex-wrap sm:space-x-8 sm:space-y-0">
                    <li>
                        <a
                            href="{{ route('register') }}"
